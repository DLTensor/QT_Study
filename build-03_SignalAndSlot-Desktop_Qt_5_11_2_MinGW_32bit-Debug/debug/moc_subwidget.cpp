...
QT_MOC_LITERAL(1, 10, 12), // "changeSignal"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "SubWidget\0changeSignal\0"
};
...
void SubWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeSignal(); break;
        case 1: _t->changeSignal((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SubWidget::changeSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SubWidget::changeSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SubWidget::changeSignal(int _t1, QString _t2)
{
